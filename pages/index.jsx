          ...
          {landingPageEvents.map((eventname, _i) => (
            <div key={_i} className=" md:mx-10 ">
              <div className="relative bg-secondary md:mb-5 hover:scale-125 transition ease-in-out duration-300 group ">
                ...
                <div className="hidden absolute z-20 bottom-0 group-hover:flex items-start justify-center flex-col font-Montserrat pl-10 md:px-4 pb-8 transition group-hover:animate-fade cursor-pointer">
                  <span className="capitalize text-base">{eventname.name}</span>
                  <span className="text-2xs font-extralight max-w-[10rem] md:max-w-xs ">
